...
| R12-02 | Browser, frozen executable, installer/MSIX, signing and clean-machine qualification | active | `store/pyinstaller/nh_family_law_llm.spec`, `store/msix/identity.example.json`, `dist/windows-portable-v2/` | Essential frozen executable passed its Store-mode smoke workflow; live browser, MSIX, signing, WACK, and clean-machine evidence remain. |
